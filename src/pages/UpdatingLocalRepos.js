...
Updating Local Git repository
      ...
      <Typography variant='h5' textAlign='center' my={4}>🔽This is a video I strongly encourage you to watch , in order to better understand how to update local git repositories:</Typography>
...
<Typography variant='h5' textAlign='center' my={3}>🔽 Here are some frequently asked questions about updating local Git repositories 🔽</Typography>

<div className='container'>
<Typography variant='h3'>Q&A about local Git repositories </Typography>
