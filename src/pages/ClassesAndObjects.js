...
<Typography variant='h2' id='title' sx={{textDecoration:'underline',textUnderlinePosition:'under'}}>
      ...
      <Typography variant='h5' textAlign='center' my={4}>🔽This is a video I strongly encourage you to watch , in order to better understand what Java Classes and Objects  is:</Typography>
...
<Typography variant='h5' textAlign='center' my={3}>🔽 Here are some frequently asked questions about Java Classes and Objects 🔽</Typography>

<div className='container'>
<Typography variant='h3'>Q&A about Java Classes and Objects </Typography>
